...
public class ReviewsController
{
	...
	// public ModelAndView getReviewsShopDetailList(ReviewsDetailPager
	// reviewsDetailPager, HttpSession session, ReviewsDTO reviewsDTO) throws
	// Exception{
	//
	// MemberDTO memberDTO = (MemberDTO)session.getAttribute("member");
	//
	...
	//
	// List<ReviewsDTO> ar =
	// reviewsService.getReviewsShopDetailList(reviewsDetailPager);
	//
	...
	// 리뷰리스트 (Model)
	// public String getReviewsList(ReviewsPager reviewsPager, HttpSession session,
	// ReviewsDTO reviewsDTO, Model model) throws Exception{
	//
	// MemberDTO memberDTO = (MemberDTO)session.getAttribute("member");
	//
	// reviewsDTO.setUserID(memberDTO.getUserID());
