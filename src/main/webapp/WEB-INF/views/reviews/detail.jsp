...
<style>
	...
	<section class="container-fluid col-lg-6 mt-5">
			...
			<tbody>
				<tr>
					...
					<td>
						...
						<!-- Modal -->
						<!--모달에 뜨는 닫기창-->
						<span class="close">&times;</span> <img class="modeal_contents" id="rvimg">
					</td>
					<!-- 부트스트랩 모달 버튼-->

				</tr>
				<button type="button" id="modalExecute" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Launch demo modal</button>
		...
		<!----- 모달 ------>
		<div>
			<button type="button" style="display: none;" id="up" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2"
		...
		<a href="./list">목록</a> <a href="./update?reviewNum=${dto.reviewNum}">수정</a> <a href="./delete?reviewNum=${dto.reviewNum}">삭제</a>
