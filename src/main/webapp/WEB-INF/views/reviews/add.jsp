...
<body>
	...
	<section class="container-fluid col-lg-6 mt-5">
		...
		<form action="./add" method="post" enctype="multipart/form-data">
			...
			<input type="text" name="shopNum" id="shopNum" value="${dto.shopNum}">
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<textarea class="form-control" name="contents" id="contents" cols="10" rows="5" placeholder="내용: ${dto.contents}"></textarea>
			</div>
		...
		<a href="./list">리스트</a> <a href="./update?reviewNum=${dto.reviewNum}">수정</a> <a href="./delete?reviewNum=${dto.reviewNum}">삭제</a>
		<div>
