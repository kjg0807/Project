...
<body>
	...
	<form action="../member/adupdate" method="post" id="frm">
		<br>
		<h2>관리자 전용 페이지 - 회원 정보 수정</h2>
		<section class="col-lg-6 container-fluid mt-4">
			<div class="row">
				<!-- id -->
				<div class="mb-3">
					<label class="form-label">아이디</label>
					<input type="text" class="form-control" name="userid" id="id" value="${member.userid}" disabled>
				...
				<div class="mb-7">
					...
					<div class="emcs">
						...
						<input style="width: 37%; padding: 5px; border: 1px solid #dedede" name="emaill" id="emaill" type="text">
						<input style="width: 37%; padding: 5px; border: 1px solid #dedede" name="email2" id="email2" type="text">
						<br>
						<select style="width: 27%; justify-content: right;" name="select_email" id="emses" class="kind">
