...
<html lang="en">
<head>
<link rel="shortcut icon" type="image/x-icon" s
		...
		<div class="container px-4 px-lg-5 mt-2">
			...
			<div>
				...
				<button onclick="window.location.href='#top'"
					style="color: black; box-shadow: rgb(204, 219, 232) 3px 3px 6px 0px inset, rgba(255, 255, 255, 0.5) -3px -3px 6px 1px inset;"
				>위로가기</button>

			</div>

		</div>
		<a href="./chat/chat">chat</a> <a href="./party/list">list</a>
	</section>
